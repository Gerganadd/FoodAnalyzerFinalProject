...
import bg.sofia.uni.fmi.mjt.server.foods.Food;
...
public class HttpRequestFactoryTest {
    ...
    void testCreateRequestForFoodByGtinUpcCodeWithValidCode() {
        ...
        Assertions.assertDoesNotThrow(() -> HttpRequestFactory.createRequestForFoodByGtinUpcCode(gtinUpc),
    ...
    void testCreateRequestForFoodByFcdIdWithValidCode() {
        ...
        Assertions.assertDoesNotThrow(() -> HttpRequestFactory.createRequestForFoodByFcdId(fcdId),
                "Expected not to throw exception");
    ...
    void testCreateRequestForFoodsByNameWithValidName() {
        ...
        Assertions.assertDoesNotThrow(() -> HttpRequestFactory.createRequestForFoodsByName(name),
                "Expected not to throw exception");
